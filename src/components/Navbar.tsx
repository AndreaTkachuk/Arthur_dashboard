...
const navItems = [
  ...
  { id: 3, name: "Brokers", path: "/brockers", icon: Users },
  ...
  { id: 7, name: "Admin", path: "/note", icon: KeyRound },
  { id: 8, name: "Admin", path: "/note", icon: KeyRound },
  { id: 9, name: "Admin", path: "/note", icon: KeyRound },
  { id: 10, name: "Admin", path: "/note", icon: KeyRound },
  { id: 11, name: "Admin", path: "/note", icon: KeyRound },
  { id: 12, name: "Admin", path: "/note", icon: KeyRound },
];
    ...
    <header className="pt-4">
      <div className="container mx-auto">
        ...
        <div className="relative">
          <nav
            ref={containerRef}
            className="flex gap-1 mt-[15px] mb-[19px] mr-[120px] overflow-hidden"
          >
            {navItems.map((item) => {
              const isActive =
              ...
              return (
                ...
                >
                  <item.icon
                    size={18}
                    className={`${isActive ? "text-text" : "text-primary"}`}
                  />
